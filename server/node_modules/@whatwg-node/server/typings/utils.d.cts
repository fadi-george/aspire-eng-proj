...
export declare function normalizeNodeRequest(nodeRequest: NodeRequest, fetchAPI: FetchAPI, nodeResponse?: NodeResponse): Request;
...
export declare function sendNodeResponse(fetchResponse: Response, serverResponse: NodeResponse, nodeRequest: NodeRequest): MaybePromise<void>;
